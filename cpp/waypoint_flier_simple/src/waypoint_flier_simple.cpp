...
namespace pairs_example_waypoint_flier_simple
{
...
private:
  ...
  pairs_msgs::ReferenceStamped ref_;
  ...
  double distance(const pairs_msgs::ReferenceStamped& waypoint, const nav_msgs::Odometry& odom);
...
double WaypointFlierSimple::distance(const pairs_msgs::ReferenceStamped& waypoint, const nav_msgs::Odometry& odom) {
...
PLUGINLIB_EXPORT_CLASS(pairs_example_waypoint_flier_simple::WaypointFlierSimple, nodelet::Nodelet);
