...
namespace pairs_example_plugins
{
...
class ExamplePlugin : public pairs_example_plugin_manager::Plugin {

public:
  void initialize(const ros::NodeHandle& parent_nh, const std::string& name, const std::string& name_space,
                  std::shared_ptr<pairs_example_plugin_manager::CommonHandlers_t> common_handlers);
...
void ExamplePlugin::initialize(const ros::NodeHandle& parent_nh, const std::string& name, const std::string& name_space,
  ...
  pairs_lib::ParamLoader param_loader(nh_, "ExamplePlugin");

  param_loader.addYamlFile(ros::package::getPath("pairs_example_plugins") + "/config/example_plugin.yaml");
...
PLUGINLIB_EXPORT_CLASS(pairs_example_plugins::example_plugin::ExamplePlugin, pairs_example_plugin_manager::Plugin)
